            ...
            if(err){
                ...
                connection.query(sql,function(err,results){
                    if(err){
                        ...
                        connection.release();
                        return callback(null,{code:200,message:"User activity retrived successfully",data:results});
                    }
                })
            }
        })
            ...
            if(err){
                ...
                connection.query(sql,function(err,results){
                    if(err){
                        ...
                        connection.release();
                        return callback(null,{code:200,message:"User notifications retrived successfully",data:results})
                    }
                })
            }
        })
            ...
            if(err){
                ...
                connection.query("UPDATE producer_user SET ? WHERE id="+producerId,updateData,function(err,results){
                    if(err){
                        ...
                        connection.release();
                        return callback(null,{code:200,message:"Producer profile updated successfully",data:null})
                    }
                })
            ...
            if(err){
                ...
                connection.query(sql,function(err,results){
                    if(err){
                        ...
                        connection.release();
                        return callback(null,{code:200,message:"Producer transactions fetched successfully",data:results});
                    }
                })
            }
        })
            ...
            if(err){
                ...
                dustbins.forEach(dustbin => {
                    const singleDustbinData={
                        ...
                        total_capacity:(dustbin.current_capacity*100/dustbin.total_capacity), // use total capacity in db to find percentage
                    }
                ...
                connection.release();
                return callback(null,{code:200,message:"Dashboard fetched successfully",data:responseData});
    ...
    getStatistics:(data,callback)=>{
        ...
        dbPromise(async function(err,connection){
            if(err){
                ...
                connection.release();
                return callback(null,{code:200,message:"Statistics fetched successfully",data:responseData});
            }
        })
    },
    ...
    getAverageWaste:(data,callback)=>{
        ...
        dbPromise(async function(err,connection){
            if(err){
                ...
                connection.release();
                return callback(null,{code:200,message:"Average waste fetched successfully",data:average_waste});
            }
        })
    },
    ...
    getWasteDistribution:(data,callback)=>{
        ...
        dbPromise(async function(err,connection){
            if(err){
                ...
                connection.release();
                return callback(null,{code:200,message:"Waste distribution fetched successfully",data:wasteDistribution});
            }
        })
    },
    ...
    getRecoveryDistribution:(data,callback)=>{
        ...
        dbPromise(async function(err,connection){
            if(err){
                ...
                connection.release();
                return callback(null,{code:200,message:"Recovery distribution fetched successfully",data:recoveryDistribution});
            }
        })
    }
}